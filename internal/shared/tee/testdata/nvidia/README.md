...
- `device-root.pem` — the NVIDIA Device Identity CA (self-signed, SHA-256
  fingerprint `102bf659…167b48`), and `rim-root.pem` — the NVIDIA CoRIM
  signing Root CA (fingerprint `12977b51…1df5d1`), both as shipped in
  NVIDIA's open-source verifier (github.com/NVIDIA/nvtrust,
