...
#
# 03-demo1-single-bundle.sh — Demo 1 round-trip on real SEV-SNP hardware.
# Pulls a model via Ollama, seals it, restores to a different path,
# verifies every blob digest matches the envelope, runs a tamper test.
