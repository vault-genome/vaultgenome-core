...
static const oe_ecall_info_t _binding_ecall_info_table[] = 
{
    { "get_quote_with_report_data_ecall" },
...
oe_result_t binding_get_quote_with_report_data_ecall(
    ...
    size_t* report_buffer_size)
{
    ...
    /* Marshalling struct. */
    get_quote_with_report_data_ecall_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.report_data = (uint8_t*)report_data;
    _args.report_data_size = report_data_size;
    _args.report_buffer = (uint8_t**)report_buffer;
    _args.report_buffer_size = (size_t*)report_buffer_size;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(get_quote_with_report_data_ecall_args_t));
    if (report_data)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.report_data_size);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(get_quote_with_report_data_ecall_args_t));
    if (report_buffer)
    ...
    _pargs_in = (get_quote_with_report_data_ecall_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (report_data)
        OE_WRITE_IN_PARAM(report_data, 1, _args.report_data_size, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _binding_ecall_info_table[binding_fcn_id_get_quote_with_report_data_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (get_quote_with_report_data_ecall_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(binding_get_quote_with_report_data_ecall, get_quote_with_report_data_ecall);

oe_result_t binding_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _binding_ecall_info_table[binding_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(binding_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t binding_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _binding_ecall_info_table[binding_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(binding_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t binding_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _binding_ecall_info_table[binding_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(binding_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t binding_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _binding_ecall_info_table[binding_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(binding_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t binding_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _binding_ecall_info_table[binding_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(binding_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);

oe_result_t binding_oe_log_init_ecall(
    oe_enclave_t* enclave,
    ...
    uint32_t log_level)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _binding_ecall_info_table[binding_fcn_id_oe_log_init_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(binding_oe_log_init_ecall, oe_log_init_ecall);
...
static oe_ocall_func_t _binding_ocall_function_table[] = {
...
oe_result_t oe_create_binding_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _binding_ocall_function_table,
               90,
               _binding_ecall_info_table,
                7,
               enclave);
}
